...
func (uc *HandleMessageUsecase) handleHelp() string {
	...
	resp += "- *Lacak Waktu/Durasi*: Tambahkan waktu bacaan (menit/jam), misal: `Alhamdulillah 5 halaman, 16 menit` atau `Alhamdulillah juz 30 selama 1 jam`\n\n"
	...
	resp += "- `!cara`: Lihat bantuan ini lagi\n\n"
